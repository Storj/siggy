...
class Test(unittest.TestCase):
    ...
    def test_verify_signature_valid(self):
        self.assertEqual(siggy.verify_signature(*TestVectors.sig_valid_vector[0]),TestVectors.sig_valid_vector[1])        
        
    def test_verify_signature_invalid(self):
        self.assertEqual(siggy.verify_signature(*TestVectors.sig_invalid_vector[0]),TestVectors.sig_invalid_vector[1]) 
...
class TestVectors(object):    
    ...
    sig_valid_vector = (('test message','HyzVUenXXo4pa+kgm1vS8PNJM83eIXFC5r0q86FGbqFcdla6rcw72/ciXiEPfjli3ENfwWuESHhv6K9esI0dl5I=','19qVgG8C6eXwKMMyvVegsi3xCsKyk3Z3jV'),True)
    sig_invalid_vector = (('test message1','HyzVUenXXo4pa+kgm1vS8PNJM83eIXFC5r0q86FGbqFcdla6rcw72/ciXiEPfjli3ENfwWuESHhv6K9esI0dl5I=','19qVgG8C6eXwKMMyvVegsi3xCsKyk3Z3jV'),False)